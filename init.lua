  ...
  },
  {
    ...
    config = vim.schedule_wrap(function(_, opts)
      ...
      vim.diagnostic.config {
        ...
        underline = { severity = { vim.diagnostic.severity.ERROR, vim.diagnostic.severity.WARN } }, ---@type vim.diagnostic.Opts.Underline
      ...
      vim.tbl_filter(configure, vim.tbl_keys(opts.servers))
